...
public class SlopOne {
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(SlopOne.class);
	...
	public SlopOne(String jdbcUrl,String user,String passwd){
	...
	public static void main(String[] args) {
		...
		slopone.setStmt(new ml_1m_Statement());
		...
		for( Map<String,Object> ite:tests){
			...
			double score=slopone.predictScore(user1, item);
