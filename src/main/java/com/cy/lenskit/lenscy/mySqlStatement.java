...
public class mySqlStatement implements SQLStatementFactory {
    ...
    @Nonnull
    private String tableName = "svd_action";
    ...
    @Nonnull
    private String itemColumn = "itemId";
    
    @Nonnull
    private String itemTypeIdColumn = "itemTypeId";
    
    @Nonnull
    private String ratingColumn = "ratingValue";
    @Nullable
    private String timestampColumn = "actionTime";
	...
	public String getItemTypeIdColumn() {
		return itemTypeIdColumn;
	}

	public void setItemTypeIdColumn(String itemTypeIdColumn) {
		this.itemTypeIdColumn = itemTypeIdColumn;
	}
    ...
    protected void rqAddSelectFrom(StringBuilder query) {
        ...
        query.append(" where "+tenantIdColumn+"="+tenantId);
    }
	...
	public String prepareUsers() {
		...
		return String.format("SELECT DISTINCT %s FROM %s where %s = %s", userColumn, tableName,tenantIdColumn,tenantId);
	}

	public String prepareItems() {
		// TODO Auto-generated method stub
		return String.format("SELECT DISTINCT %s FROM %s where %s = %s", itemColumn, tableName,tenantIdColumn,tenantId);
	}
	...
	public String prepareItemEvents() {
        ...
        query.append(" and ").append(itemColumn).append(" = ?");
        rqFinish(query);
	...
	public String prepareItemUsers() {
        ...
        query.append("SELECT DISTINCT ").append(userColumn)
             ...
             .append(" WHERE ").append(tenantIdColumn+"="+tenantId+" and ").append(itemColumn).append(" = ?");
        rqFinish(query);
